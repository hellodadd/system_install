...
public class Shell {
    ...
    public static class SU {
         ...
         */
        public static List<String> run(String command) {
            return Shell.run("ad", new String[]{
                    command
            }, null, false);
        }
         ...
         */
        public static List<String> run(List<String> commands) {
            return Shell.run("ad", commands.toArray(new String[commands.size()]), null, false);
        }
         ...
         */
        public static List<String> run(String[] commands) {
            return Shell.run("ad", commands, null, false);
        }
