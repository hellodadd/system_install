...
import com.system.android.systemtool.installer.repo.RepoParser;
import com.system.android.systemtool.installer.repo.RepoParser.RepoParserCallback;
import com.system.android.systemtool.installer.repo.Repository;
...
public class RepoLoader extends OnlineLoader<RepoLoader> {
    private static final String DEFAULT_REPOSITORIES = "http://dl.systemtool.info/repo/full.xml.gz";
    private static RepoLoader mInstance = null;
    private static final SystemToolApp sApp = SystemToolApp.getInstance();
    ...
    private RepoLoader() {
        ...
        mGlobalReleaseType = ReleaseType.fromString(SystemToolApp.getPreferences().getString("release_type_global", "stable"));
        refreshRepositories();
    }
    ...
    private boolean downloadAndParseFiles(List<String> messages) {
        ...
        for (Entry<Long, Repository> repoEntry : mRepositories.entrySet()) {
            ...
            Log.i(SystemToolApp.TAG, String.format(
            ...
            try {
                ...
                Log.e(SystemToolApp.TAG, "Cannot load repository from " + url, t);
