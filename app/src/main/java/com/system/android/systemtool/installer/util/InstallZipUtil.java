...
import com.system.android.systemtool.installer.BuildConfig;
import com.system.android.systemtool.installer.R;
import com.system.android.systemtool.installer.SystemToolApp;
import com.system.android.systemtool.installer.installation.FlashCallback;
...
public final class InstallZipUtil {
    ...
    public static class ZipCheckResult {
        ...
        private SystemToolProp mSystemToolProp = null;
        ...
        public boolean hasSystemToolProp() {
            return mSystemToolProp != null;
        }

        public SystemToolProp getSystemToolProp() {
            return mSystemToolProp;
        }
    ...
    public static ZipCheckResult checkZip(ZipFile zip) {
        ...
        ZipEntry systemtoolPropEntry = zip.getEntry("system/systemtool.prop");
        if (systemtoolPropEntry != null) {
            try {
                result.mSystemToolProp = parseSystemToolProp(zip.getInputStream(systemtoolPropEntry));
            } catch (IOException e) {
                Log.e(SystemToolApp.TAG, "Failed to read system/systemtool.prop from " + zip.getName(), e);
            }
        }
    ...
    public static class SystemToolProp {
    ...
    public static SystemToolProp parseSystemToolProp(InputStream is) throws IOException {
        SystemToolProp prop = new SystemToolProp();
    ...
    public static String messageForError(int code, Object... args) {
        Context context = SystemToolApp.getInstance();
        switch (code) {
    ...
    public static void reportMissingFeatures(Set<String> missingFeatures) {
        Log.e(SystemToolApp.TAG, "Installer version: " + BuildConfig.VERSION_NAME);
        Log.e(SystemToolApp.TAG, "Missing installer features: " + missingFeatures);
    }
