...
public class SettingsActivity extends SystemToolBaseActivity implements FolderChooserDialog.FolderCallback {
    ...
    public void onFolderSelection(@NonNull FolderChooserDialog dialog, @NonNull File folder) {
        if (folder.canWrite()) {
            SystemToolApp.getPreferences().edit().putString("download_location", folder.getPath()).apply();
        } else {
    ...
    public static class SettingsFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener, Preference.OnPreferenceClickListener {
        private static final File mDisableResourcesFlag = new File(SystemToolApp.BASE_DIR + "conf/disable_resources");
        ...
        public boolean onPreferenceClick(Preference preference) {
            if (preference.getKey().equals(downloadLocation.getKey())) {
                ...
                new FolderChooserDialog.Builder((SettingsActivity) getActivity())
                        ...
                        .initialPath(SystemToolApp.getDownloadPath())
                        .show();
            }
