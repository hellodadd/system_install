...
import com.system.android.systemtool.installer.util.HashUtil;
...
import com.system.android.systemtool.installer.util.chrome.LinkTransformationMethod;
import com.system.android.systemtool.installer.widget.DownloadView;
...
public class DownloadDetailsVersionsFragment extends ListFragment {
    ...
    public static class DownloadModuleCallback implements DownloadsUtil.DownloadFinishedCallback {
        ...
        public void onDownloadFinished(Context context,
            ...
            SystemToolApp.installApk(context, info);
        }
    }
