...
public abstract class OnlineLoader<T> extends Loader<T> {
    protected SharedPreferences mPref = SystemToolApp.getPreferences();
    ...
    private static final ConnectivityManager sConMgr
            = (ConnectivityManager) SystemToolApp.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE);
