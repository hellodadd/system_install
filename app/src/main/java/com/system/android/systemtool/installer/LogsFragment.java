...
public class LogsFragment extends Fragment {
    ...
    private File mFileErrorLog = new File(SystemToolApp.BASE_DIR + "log/error.log");
    private File mFileErrorLogOld = new File(
            SystemToolApp.BASE_DIR + "log/error.log.old");
...
*/
    ...
    private void send() {
        Uri uri = FileProvider.getUriForFile(getActivity(), "com.system.android.systemtool.installer.fileprovider", mFileErrorLog);
    ...
    private File save() {
        ...
        String filename = String.format(
                "systemtool_%s_%04d%02d%02d_%02d%02d%02d.log", "error",
