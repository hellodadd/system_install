...
public class WelcomeActivity extends SystemToolBaseActivity implements NavigationView.OnNavigationItemSelectedListener,
    ...
    private void notifyDataSetChanged() {
        ...
        boolean snackBar = SystemToolApp.getPreferences().getBoolean("snack_bar", true);
