package com.system.android.systemtool.installer.installation;
...
import com.system.android.systemtool.installer.util.DownloadsUtil;
import com.system.android.systemtool.installer.util.DownloadsUtil.DownloadFinishedCallback;
import com.system.android.systemtool.installer.util.DownloadsUtil.DownloadInfo;
import com.system.android.systemtool.installer.util.FrameworkZips;
import com.system.android.systemtool.installer.util.FrameworkZips.FrameworkZip;
import com.system.android.systemtool.installer.util.FrameworkZips.LocalFrameworkZip;
import com.system.android.systemtool.installer.util.FrameworkZips.LocalZipLoader;
import com.system.android.systemtool.installer.util.FrameworkZips.OnlineFrameworkZip;
import com.system.android.systemtool.installer.util.FrameworkZips.OnlineZipLoader;
import com.system.android.systemtool.installer.util.InstallZipUtil;
import com.system.android.systemtool.installer.util.Loader;
import com.system.android.systemtool.installer.util.NavUtil;
import com.system.android.systemtool.installer.util.RootUtil;
import com.system.android.systemtool.installer.util.RunnableWithParam;

public class StatusInstallerFragment extends Fragment {
    public static final File DISABLE_FILE = new File(SystemToolApp.BASE_DIR + "conf/disabled");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        disableSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (DISABLE_FILE.exists()) {
                    DISABLE_FILE.delete();
                    Snackbar.make(disableSwitch, R.string.systemtool_on_next_reboot, Snackbar.LENGTH_LONG).show();
                } else {
                    try {
                        DISABLE_FILE.createNewFile();
                        Snackbar.make(disableSwitch, R.string.systemtool_off_next_reboot, Snackbar.LENGTH_LONG).show();
                    } catch (IOException e) {
                        Log.e(SystemToolApp.TAG, "Could not create " + DISABLE_FILE, e);
                    }
                }
            }
        });
        ...
        if (!SystemToolApp.getPreferences().getBoolean("hide_install_warning", false)) {
                    ...
                    .onPositive(new MaterialDialog.SingleButtonCallback() {
                        ...
                        public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                            if (dialog.isPromptCheckBoxChecked()) {
                                SystemToolApp.getPreferences().edit().putBoolean("hide_install_warning", true).apply();
                            }
                        }
                    })
    ...
    private void refreshInstallStatus() {
        ...
        int active = SystemToolApp.getActiveSystemToolVersion();
        int installed = SystemToolApp.getInstalledSystemToolVersion();
        ...
        if (installed < 0) {
            ...
            txtInstallError.setText(getString(R.string.framework_not_active, SystemToolApp.getSystemToolProp().getVersion()));
            ...
            txtInstallError.setText(getString(R.string.framework_active, SystemToolApp.getSystemToolProp().getVersion()));
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mShowOutdated = SystemToolApp.getPreferences().getBoolean("framework_download_show_outdated", false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.show_outdated:
                ...
                SystemToolApp.getPreferences().edit().putBoolean("framework_download_show_outdated", mShowOutdated).apply();
    ...
    private File getCanonicalFile(File file) {
        try {
            ...
            Log.e(SystemToolApp.TAG, "Failed to get canonical file for " + file.getAbsolutePath(), e);
            return file;
        }
    }
    ...
    private void refreshKnownIssue(View v) {
        ...
        final File baseDir = new File(SystemToolApp.BASE_DIR);
        ...
        final InstallZipUtil.SystemToolProp prop = SystemToolApp.getSystemToolProp();
        ...
        if (missingFeatures != null && !missingFeatures.isEmpty()) {
            ...
            Log.e(SystemToolApp.TAG, "Base directory: " + getPathWithCanonicalPath(baseDir, baseDirCanonical));
            Log.e(SystemToolApp.TAG, "Expected: " + getPathWithCanonicalPath(baseDirActual, baseDirActualCanonical));
            ...
            issueLink = "https://github.com/rovo89/SystemToolInstaller/issues/395";
        } else if (!baseDir.exists()) {
            issueName = getString(R.string.known_issue_missing_base_directory);
            issueLink = "https://github.com/rovo89/SystemToolInstaller/issues/393";
        } else {
            issueName = null;
            issueLink = null;
        }
    ...
    private void determineVerifiedBootState(View v) {
        try {
            ...
            Log.e(SystemToolApp.TAG, "Could not detect Verified Boot state", e);
        }
    }
