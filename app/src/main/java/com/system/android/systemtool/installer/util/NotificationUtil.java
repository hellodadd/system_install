...
import com.system.android.systemtool.installer.WelcomeActivity;
...
public final class NotificationUtil {
    ...
    public static void init() {
        ...
        sContext = SystemToolApp.getInstance();
    ...
    public static void showModulesUpdatedNotification() {
        ...
        String title = sContext
                .getString(R.string.systemtool_module_updated_notification_title);
        String message = sContext
                .getString(R.string.systemtool_module_updated_notification);
